...
def generate_launch_description():
    logger = get_logger('right_arm.launch')
    ...
    logger.info('Launching right hand node')
    hand_node = Node(
        package='robot_arms_control',
        executable='hand_node',
        namespace=[namespace, '/right_arm'],
        parameters=[config_file],
        output='screen'
    )

    logger.info('Launching right elbow node')
    elbow_node = Node(
        package='robot_arms_control',
    ...
    logger.info('Launching right shoulder node')
    shoulder_node = Node(
        package='robot_arms_control',
